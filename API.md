...
- **URL**: /nfts/co![스크린샷 2025-04-23 시간: 15.19.47](https://hackmd.io/_uploads/BJgjIWUkxl.png)
  llections/{id}
- **HTTP 메서드**: GET
...
- **HTTP 메서드**: `GET`
- **설명**: 컬렉션 상세 NFT 목록 조회 API(페이지 네이션,필터,검색기능 사용)
