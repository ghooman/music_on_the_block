...
### 4.3 (라벨링모드 선택시) 🎶 LyricLab

- 가사 생성 라벨링 컴포넌트

### 4.4 (라벨링모드 선택시) 🎶 MelodyLab
...
4. **main.instructions**
   ...
   **✅ 주요 가이드 요약**
   ...
   | 섹션 라벨 | Verse1, Chorus 등 반드시 포함           |
   | 줄바꿈    | 문장마다 줄바꿈 필수                    |
   | 단락 구분 | 자연스러운 단락 분리 필수               |
   | 내용 기준 | 창의적, 감정선 일관성 유지              |
   | 길이 기준 | 900~1000자 (공백 포함)                  |
