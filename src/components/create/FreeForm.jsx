...
function FreeForm() {
    ...
    <section className="freeform-section">
        <div className='freeform-section__inner'>
            <div className='freeform-section__inner__tit'>
                ...
                <p>
                    <span>
                        Write a prompt for your music.
                    </span>
                    <span>
                        To add your own lyrics, tap [Custom Lyrics].
                    </span>
                </p>
            </div>
            <textarea className="freeform-section__inner__textarea" 
        ...
        <div className='btn-full-box'>
            <button className={`btn-full-primary ${promptText.length > 0 ? 'btn-full-primary--active' : 'btn-full-primary--disabled'}`}
    ...
    <div className={`custom-lyrics-modal ${isCustomLyricsModal ? 'open' : ''}`}>
        ...
        <div className="custom-lyrics-modal__bg" onClick={() => setIsCustomLyricsModal(false)}></div>
