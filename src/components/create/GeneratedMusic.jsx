...
const GeneratedMusic = ({ lyrics, melodyData, setMusic }) => {
  ...
  const [generatedResult, setGeneratedResult] = useState({
    audio_file:
      "https://files.topmediai.com/aimusic/api/385c7953-dd4a-42f1-9a45-58be3b308795-audio.mp3",
    image_file:
      "https://files.topmediai.com/aimusic/10331247/f4d9a528-1069-414f-bade-74d494b1e89f-image.png",
    ...
    const generatedMusic = async () => {
      const formData = {
        ...
        prompt: `
                    ...
                    악기는 ${
                      melodyData?.melody_instrument[0]
                    }가 꼭 들어갔으면 좋겠습니다.
                `,
        lyrics: lyrics,
        title: "가사",
