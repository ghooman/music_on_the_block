...
const MelodyMaker = ({
    ...
    const isAnyFieldFilled =
        ...
        (melody_style && melody_style.length > 0 && melody_style[0].trim() !== '') ||
        ...
        <div className="create__melody-maker">
            ...
            <SelectItemWrap selectedLanguage={selectedLanguage} setSelectedLanguage={setSelectedLanguage}>
                ...
                <div className="selected-tag-list">
                    <div className="selected-tag-list__title">
                        ...
                        <span>
                            current length :
                            <span style={{ color: promptPreview?.length > 200 && 'red' }}>{promptPreview?.length}</span>
                        </span>
                    </div>
            ...
            <div className="button-wrap">
                <div className="button-wrap__left">
                    ...
                    <ExpandedButton className="skip" onClick={onSkip} style={{ display: 'none' }}>
                        Skip
                    </ExpandedButton>
                </div>
                <ExpandedButton
                    className={loading || promptPreview.length > 200 || !isAnyFieldFilled ? 'next' : 'next enable'}
