  ...
  return (
    <div className="create__select-components">
      <div className="tag-select-title">
        ...
        {dropdown && (
          <div
            className={`tag-select-title__dropdown-toggle ${
              visible ? "visible" : ""
            }`}
            onClick={() => setVisible((prev) => !prev)}
          >
            <div
              className={`tag-select-title__dropdown-thumb ${
                visible ? "visible" : ""
              }`}
            ></div>
          </div>
    ...
    <div className={`tag-select ${className}`}>
      ...
      <div className="tag-input-box">
        ...
        <div className="tag-input-comment-button-wrap">
          ...
          <ExpandedButton
            className="tag-input-comment-button"
            onClick={addItem}
          >
            Add
          </ExpandedButton>
  ...
  return (
    <div className="tag-select">
      ...
      >
        ...
        {tempo > 80 &&
          tempo <= 120 &&
          "Medium: Balanced and versatile (81-120 BPM)"}
