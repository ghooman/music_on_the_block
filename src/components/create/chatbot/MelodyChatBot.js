    ...
    <div className="chatbot__background">
      ...
      <section className="music__information">
        ...
        <div className="music__information__genre">
          <h3>Melody Title</h3>
          <input type="text" value={melodyTitle} placeholder="Enter" readOnly />
        </div>
        <div className="music__information__genre">
          <h3>Melody Genre</h3>
          <input type="text" value={melodyGenre} placeholder="Enter" readOnly />
        </div>
        ...
        <div className="music__information__tempo">
          <h3>Melody Tempo</h3>
          <input type="text" value={melodyTempo} placeholder="Enter" readOnly />
        </div>
