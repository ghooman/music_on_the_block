    ...
    <div className="info-modal__overlay" onClick={onClose}>
      <div className="info-modal__container" onClick={(e) => e.stopPropagation()}>
        ...
        <ul className="info-modal__content">
          ...
          <li>
            <h3>{t('Minting NFT')}</h3>
            <div>{artistInfo.mintingNFT}{isKorean ? '개' : ''}</div>
          </li>
          <li>
            <h3>{t('Selling NFT')}</h3>
            <div>{artistInfo.sellingNFT}{isKorean ? '개' : ''}</div>
          </li>
          <li>
            <h3>{t('Album')}</h3>
            <div>{artistInfo.album}{isKorean ? '개' : ''}</div>
          </li>
          <li>
            <h3>{t('Collection')}</h3>
            <div>{artistInfo.collection}{isKorean ? '개' : ''}</div>
          </li>
