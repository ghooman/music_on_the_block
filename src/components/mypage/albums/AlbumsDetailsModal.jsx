...
const AlbumsDetailsModal = ({
    ...
    const [isFromAlbumDetail, setIsFromAlbumDetail] = useState(isFromAlbumDetailProp || false);
    ...
    useEffect(() => {
        ...
        setIsFromAlbumDetail(isFromAlbumDetailProp || location.pathname.includes('/album/'));
        console.log('isFromAlbumDetail 설정됨:', isFromAlbumDetailProp || location.pathname.includes('/album/'));
            ...
            <ModalWrap onClose={setShowDetailModal} title="Album Details">
                <div className="albums-details-modal">
                    <div className="albums-details-modal__info">
                        <p className="albums-details-modal__info__title">[{album?.album_name}]</p>
                        <p className="albums-details-modal__info__artist">{album?.name}</p>
                        <p className="albums-details-modal__info__songs">{album?.song_cnt} Songs</p>
                    </div>
                    <div className="albums-details-modal__button-box">
                        <div className="albums-details-modal__button-box__edit">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    navigate(`/edit-album-songs/${album.id}`);
                                }}
                            >
                                Edit Songs
                            </button>
                        </div>
                        <button className="albums-details-modal__button__delete" onClick={() => setDeleteConfirm(true)}>
                            Delete Album
                        </button>
                    </div>
                </div>
            ...
            <ModalWrap onClose={setShowDetailModal} title="Delete Album">
                <div className="albums-details-modal">
                    <div className="albums-details-modal__delete-confirm">
                        <p className="albums-details-modal__delete-confirm__text">This action cannot be undone.</p>
                    ...
                    <div className="albums-details-modal__button-box">
                        ...
                        <button className="albums-details-modal__button__delete-confirm" onClick={handleDeleteAlbum}>
                            Delete Album
                        </button>
                    </div>
                </div>
            ...
            <ModalWrap onClose={setShowDetailModal} title="">
                <div className="albums-details-modal">
                    <div className="albums-details-modal__success">
                        <p className="albums-details-modal__success__text">Album deleted successfully.</p>
                    </div>
                    <div className="albums-details-modal__button-box">
                        <button className="albums-details-modal__button__ok" onClick={handleOkClick}>
                            Ok
                        </button>
                    </div>
                </div>
