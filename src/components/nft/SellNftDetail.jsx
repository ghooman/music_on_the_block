        ...
        <ContentWrap title={t('Set NFT sell conditions')}>
          ...
          <div className="sell-nft-input-box__cover">
            <div className="sell-nft-input-box">
              <p className="sell-nft-input-box__title">{t('Sell price')}</p>
              <div className="sell-nft-input-box__value">
                <input
                  placeholder={t('How much will you sell each NFT for? (e.g. 0.05)')}
                  value={sellPrice}
            ...
            <div className="sell-nft-select-box">
              <p className="sell-nft-select-box__title">{t(`Select token`)}</p>
