...
const enLyric = {
    chatbot: {
        initialMessage: 'Please tell me the genre of the song you would like to create!',
        systemMessage:
            ...
            "The conversation should proceed step-by-step reflecting the user's choices. Please ensure that the final prompt strictly adheres to the above format.",
    },
    extraction: {
