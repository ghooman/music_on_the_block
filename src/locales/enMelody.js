...
const enMelody = {
  chatbot: {
    ...
    systemMessage:
      ...
      `4. Ask the user to choose the "Voice" (male or female).\nYou must use this exact phrase:\n\`That’s a nice title! Now, please choose the voice for your song. Do you think a male or female voice fits better?\`\n` +
      `5. Ask the user which "Instruments" they want to use (e.g., piano, drums, etc.).\nYou must use this exact phrase:\n\`Thank you! What instruments would you like to include in this song? For example, piano, drums, guitar, and so on.\`\n` +
      `6. Ask the user to provide the "Tempo (BGM)" as a number between 60 and 120.\nYou must use this exact phrase:\n\`Great choice! Please select a tempo for the song — any number between 60 and 120. Which number feels right to you?\`\n` +
