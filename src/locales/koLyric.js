...
const koLyric = {
  chatbot: {
    ...
    systemMessage:
      ...
      '2. 실패 시 (입력이 부적절하다면) **오직** "가사를 생성할 수 없습니다. 다시 입력해주세요." **한 줄만** 출력하고, 그 외에는 어떤 부가 텍스트도 절대 포함하지 않습니다.\n' +
      '3. 사용자가 이후 가사에 추가 요청을 하면, 요청을 반영해 전체 가사를 재생성하여 **오직 가사만** 출력합니다.\n' +
      '4. 요청이 구체적이지 않으면 자유롭게 가사를 생성합니다.\n' +
      '5. 가사 구조는 유연하게 작성하되, Verse1, Chorus 등 구분자가 필요하다면 자연스럽게 포함합니다.\n' +
      '6. 별도 길이 요청이 없으면 900~1,000자(공백 포함)로 맞춥니다.\n\n' +
