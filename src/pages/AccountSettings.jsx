...
const AccountSettings = () => {
    ...
    const validate = () => {
        ...
        if (intro === 'error') {
            ...
            errors.intro.push('Invalid password. Please include uppercase, lowercase, and special characters.');
        }
                ...
                <div className="account-setting__info-box">
                    ...
                    <div className="info-box__picture-box">
                        ...
                        <div className="picture-box__edit-box">
                            ...
                            <button className="picture-box__edit-btn" onClick={() => fileInputRef.current.click()}>
                ...
                <div className="account-setting__user-info">
                    ...
                    <div className="user-info__item">
                        ...
                        <div className="user-info__desc-box">
                            <span className="user-info__desc">Write your Introduction in 150 characters or less.</span>
