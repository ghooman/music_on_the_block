            ...
            >
                <div className="album__header__album-cover">
                    <p
                        ...
                        style={{
                            backgroundImage: `url(${
                                selectedTrack?.image === 'string' ? coverImg10 : selectedTrack?.image
                            })`,
                            // backgroundImage: `url(${selectedTrack?.image?.trim() ? selectedTrack.image : defaultCoverImg})`,
                        }}
                    ></p>
                        ...
                        >
                            <div className="album__content-list__list__item__left">
                                <p
                                    ...
                                    style={{
                                        backgroundImage: `url(${track.image === 'string' ? coverImg10 : track.image})`,
                                    }}
                                ></p>
                                <span className="time">
                        ...
                        >
                            ...
                            <div className="swiper-music-list__item__right">
                                ...
                                <div className="swiper-music-list__item__right__user">
                                    ...
                                    <button className="swiper-music-list__item__right__user__btn">유저정보</button>
                                </div>
                            </div>
                        </SwiperSlide>
                    ))}
