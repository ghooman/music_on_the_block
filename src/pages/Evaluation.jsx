      ...
      <section className="join-evaluation">
        <article className="join-evaluation__item two">
          <dl className="join-evaluation__item__title">
            ...
            <dd>React to music, earn MIC points. Emotion becomes value.</dd>
          </dl>
          <dl className="join-evaluation__item__title">
            <dt>
            ...
            <dd>Your reactions train AI to match your taste—and inspire creation.</dd>
          </dl>
        </article>
        <article className="join-evaluation__item">
          <dl className="join-evaluation__item__title">
            ...
            <dd>
              Songs with a lot of emotional evaluations can have higher NFT values. Your single
              emotion becomes a factor that increases the asset value of the song.
            </dd>
          </dl>
        </article>
        <article className="join-evaluation__item two">
          <dl className="join-evaluation__item__title">
            ...
            <dd>Emotions inspire new music and increase its value.</dd>
          </dl>
          <dl className="join-evaluation__item__title">
            <dt>
            ...
            <dd>The more you feel, the smarter your rewards get.</dd>
          </dl>
        </article>
      </section>
    </>
      ...
      <div className="judge">
        <div className="judge__item">
          ...
          <p className="judge__txt">
            A veteran composer who listens with his soul. For him, music isn’t perfect unless it’s
            honest.
          </p>
        </div>
        <div className="judge__item">
          ...
          <p className="judge__txt">
            Precision is his rhythm. A razor-sharp rapper who breaks down your flow like it’s
            science.
          </p>
        </div>
        <div className="judge__item">
      ...
      <section className="ai-step">
        <article className="ai-step__item">
          <dl className="ai-step__item__txt">
            ...
            <dd>
              Before you begin, take a moment to learn how the evaluation works and who will be
              Evaluationing your song.
            </dd>
          </dl>
        ...
        <article className="ai-step__item reversal">
          <dl className="ai-step__item__txt">
            <dt>Choose</dt>
            <dd>
              Once you start the evaluation, please follow the steps.After completing all steps,
        ...
        <article className="ai-step__item">
          <dl className="ai-step__item__txt">
            ...
            <dd>
              When your evaluation is done, check your insights. You can share the results with
              friends or keep them for your own.
            </dd>
          </dl>
          <div className="ai-step__item__step">
        ...
        <article className="ai-step__item reversal">
          <dl className="ai-step__item__txt">
            ...
            <dd>
              Explore new music, improve your work, and connect with others through shared
