          ...
          <div className="info-section">
            ...
            <div className="info-section__info-content">
              ...
              <ul className="info-section__info-list">
                <li>
                  해당 이벤트로 제공되는 상금은 전액 USDT 토큰으로 제공되며, 그에 따라 메타마스크
                  지갑 주소를 요청할 수 있습니다.
                </li>
                <li>
                  TOP 10 인기곡 제작 아티스트에게는 상금 수령을 위해 최초 메세지를 남겨주셨던
                  &#91;인스타그램 DM 혹은 카카오톡 채널&#93;로 상금 수령 관련 안내를 전송해드릴
                  예정입니다.
                </li>
                <li>
                  1계정 당 1개의 음악만 신청할 수 있으며, 재신청의 경우 기존에 등록되었던 음악이
                  삭제되며, 투표 횟수도 초기화됩니다.
                </li>
                <li>부정행위 적발 등의 문제 발견 시 예고없이 등록된 음악이 삭제될 수 있습니다.</li>
                <li>
                  2025년 9월 1일 이벤트가 종료되고, 순위 발표는 카카오톡 채널 및 홈페이지에서 확인
                  가능합니다.
                </li>
              </ul>
            </div>
